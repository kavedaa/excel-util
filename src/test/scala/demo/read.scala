...
@main def main =
  ...
  val persons2 = Excel.readFile(exampleFileName)(using sheetReader1)
  ...
  val rowReaderFactory4: Detection.RowReaderFactory[Person] = Detection.RowReaderFactory.derived(labels)
